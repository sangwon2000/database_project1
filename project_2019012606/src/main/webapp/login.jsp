...
<main class="form-signin w-100 m-auto">
  <form method="post" action="action/loginAction.jsp">
    <img class="mb-4" src="assets/brand/HYU_symbol_basic.png" alt="" width="72" height="72">
    <h1 class="h3 mb-3 fw-normal">한양대학교 수강신청</h1>
    ...
    <p class="mt-5 mb-3 text-muted">&copy; 2019012606 정상원</p>
  </form>
</main>
  </body>
</html>
